...
\begin{itemize}
    ...
    \begin{description}
        ...
        \item[-] Funciones específicas asignadas.
    ...
    \item \textbf{RF1.8 Recuperación de contraseña} \\
    El sistema debe permitir a un voluntario solicitar el restablecimiento de
    su contraseña en caso de olvido.
\end{itemize}
...
\begin{itemize}
    \item \textbf{RF4.1 Catálogo extensible de servicios} \\
    El sistema debe mantener un catálogo de tipos de servicio que el Admin
    puede ampliar y modificar sin necesidad de cambios en el código.
    \begin{description}
...
\begin{itemize}
    ...
    \begin{description}
        ...
        reposición de stock, convenios próximos a vencer.
