\subsection*{RF1.9.1 Exportar informe de cuenta}
...
\begin{itemize}
    \item Caso de éxito: El sistema exporta el informe en formato JSON. % chktex 13
...
\begin{enumerate}
    ...
    \item El sistema exporta el informe con los datos de la cuenta del usuario en formato JSON. % chktex 13
...
\begin{description}
    ...
    \begin{enumerate}
        ...
        \item[4.a.2] El sistema permite al usuario cambiar la ruta en el menú de previsualización del JSON. % chktex 13
    \end{enumerate}
...
\underline{Escenario: 3.a (error en la exportación)}\par
\vspace{0.15cm}
\textbf{Dado} que el usuario ha iniciado sesión con su cuenta Owner,\par
\textbf{Y} se encuentra en la sección \enquote{Cuenta},\par
\textbf{Cuando} selecciona la opción \enquote{Exportar informe},\par
...
Aquí incluimos los mockups de la interfaz para este requisito.
% \begin{figure}[H]
